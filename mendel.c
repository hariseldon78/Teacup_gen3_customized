...
///
/// just run init(), then run an endless loop where we pass characters from the serial RX buffer to gcode_parse_char() and check the locks
int main (void)
{
#ifndef DEBUG_MODE
        init();
